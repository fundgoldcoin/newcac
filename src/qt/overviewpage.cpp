    ...
    filter(0)
{
    ...
    ui->labelWalletStatus->setText("(" + tr("Out of sync with the ClassicAsset network") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("Out of sync with the ClassicAsset network") + ")");
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("CAC")
    updateDisplayUnit();
}
