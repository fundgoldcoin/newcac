...
const string strMessageMagic = "ClassicAsset Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees) 
{
	...
	else if (pindexBest->nHeight+1 < 202)
    {
      nSubsidy = 30000 * COIN;
      return nSubsidy + nFees;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
	...
	else if(pindexBest->nHeight < 2628001)
    {
        nSubsidy = 1.065 * COIN;
        return nSubsidy + nFees;
    }	
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ClassicAsset", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block        
        const char* pszTimestamp = "ClassicAsset blockchain 2017-02-24 11:18:18(GMT+8)";
        CTransaction txNew;
        txNew.nTime = 1487907898;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1487907898;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5024412;
        if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8ff8b0d20a0441bc77a04d19459328c42d9a4633050cc1c977df5dd51f5d3c7b"));
        //block.print();
